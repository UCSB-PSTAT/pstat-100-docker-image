                ...
                stage('Test') {
                    steps {
                        container('podman') {
                            ...
                            sh 'podman run -it --rm --pull=never localhost/$IMAGE_NAME R -e "library(\"bayesrules\"); library(\"coda\"); library(\"gam\"); library(\"ggdist\"); library(\"ggthemes\"); library(\"glmnet\"); library(\"gridExtra\"); library(\"kableExtra\"); library(\"leaps\"); library(\"ottr\"); library(\"palmerpenguins\"); library(\"pander\"); library(\"patchwork\"); library(\"reshape2\"); library(\"rethinking\"); library(\"splines\"); library(\"tidybayes\"); library(\"tidyverse\"); library(\"ellmer\"); library(\"ragnar\"); library(\"dagitty\"); library(\"devtools\"); library(\"loo\"); library(\"mvtnorm\"); library(\"rstanarm\"); library(\"umap\")"'
